...
const steps = [
  {
    ...
    description: "Link your GitHub repositories with a single click. AutoReview starts watching immediately.",
  },
  {
    icon: GitPullRequest,
    title: "Open a Pull Request",
    description: "Push your code and open a PR as usual. AutoReview detects it automatically.",
  },
  {
    icon: Bot,
    title: "Get AI Review",
    description: "Receive detailed AI-powered code reviews with actionable inline comments in seconds.",
  },
];
